...
class TestRegistration:
    ...
    def test_invalid_password_error(self, driver):
        ...
        driver.find_element(*Locators.BUTTON_REGISTRATION).click()
        error_invalid_password = WebDriverWait(driver, 3).until(EC.presence_of_element_located(Locators.ERROR_INVALID_PASSWORD))
        assert error_invalid_password.is_displayed()
